...
Bibliotecas Python
bashpython -m pip install Pillow img2pdf pytesseract pypdf
Tesseract OCR
...
Extraia os arquivos do instalador do Tesseract em uma pasta chamada tesseract/ ao lado do script
Baixe o arquivo de idioma e coloque em tesseract/tessdata/:
...
Como usar
bashpython canofile-converter-3.py
...
ColunaDescriçãoGabineteNome do gabinete (CAB1V2, CAB2V2, etc.)NºINDEX_NO do registro no DBFNomeChave de indexação conforme lida no CanofilePáginasQuantidade de imagens mapeadasPDF GeradoSim, Não, Erro ou Sem imagensOCRSim, Não, Parcial (X de Y páginas) ou -VerificaçãoOK, CORROMPIDO: motivo ou DIVERGENTE: motivoObservaçãoInformações adicionais (duplicados, erros, etc.)
